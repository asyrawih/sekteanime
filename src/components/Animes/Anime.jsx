   ...
   return (
      <div class="xl:w-1/6 md:w-1/3 sm:w-1/2 p-4">
         <div class="flex relative">
            <img alt="gallery" class="absolute inset-0 w-full h-full object-cover object-center rounded-lg hover:cursor-pointer" src="https://i0.wp.com/sektekomik.com/wp-content/uploads/2020/02/fe710002a25021f6e34e-906807-15BNQMmy.jpg?resize=165,225" />
